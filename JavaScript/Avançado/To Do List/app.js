...
const limpar = document.querySelector(".botao_del_todos");
...
paleta1.addEventListener('click', () => definePaleta('purple'));
paleta2.addEventListener('mousemove', () => definePaleta('blue'));
paleta3.addEventListener('dblclick', () => definePaleta('red'));
...
// Manipulador de Eventos, melhor legibilidade - addEventListener()
