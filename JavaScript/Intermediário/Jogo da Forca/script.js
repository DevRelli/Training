...
const categorias = {
    ...
    animais: ["cavalo","cachorro","gato","arara"],
...
function definePalavra(){
    ...
    indicePalavra = retornaNumAleatorio(arrayPalavras.length)
...
console.log(retornaArrayCategorias()); // -> retorna as keys do array de categorias 
